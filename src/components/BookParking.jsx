...
function BookParking({showHeader=true,showFooter=true}) {
  ...
  <h2 className='text-light  fw-bolder'> <pre>Parking Reservation</pre> </h2>
    <p className='text-light  fw-bold'> <pre>Allows users to reserve a parking spot in advance.</pre></p>
    <Link type="button" class="btn btn-outline-warning my-5" to="/bookspot">Book Spot</Link>
    </div>
</div>
</div>
{showFooter&&<Footer/>}
